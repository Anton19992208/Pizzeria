...
public class PizzaController {
    ...
    public ResponseEntity saveNewBeer(@RequestBody @Validated PizzaDto pizzaDto) {
        return new ResponseEntity<>(pizzaService.savePizza(pizzaDto), CREATED);
    }

    @PutMapping("beer/{pizzaId}")
    public ResponseEntity updateBeerById(@PathVariable("pizzaId") Long beerId, @RequestBody @Validated PizzaDto beerDto) {
